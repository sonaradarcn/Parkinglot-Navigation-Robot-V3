    ...
    <div class="right-side">
        <div class="form-container">
            <div style='align-items: center;justify-content: center;display: flex;'>
                <img src="../static/images/debug.png" style="width: 72px;height: 72px;border-radius: 2px;">
            </div>
            <h2 style="letter-spacing: 2px;font-size: 24px;">调试模式</h2>
            <div style="font-size: 20px;text-align: center;line-height: 30px;font-weight: 600">
                调试模式已启用<br />请通过控制杆操控机器人
            </div>
        </div>
    </div>
...
function step_name() {
    ...
    function pollBackend() {
        ...
        const stepName = 'step_debug'; // 这里的 step_name 可以动态设置
