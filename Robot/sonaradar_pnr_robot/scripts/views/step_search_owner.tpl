...
<body>
    ...
    <div class="right-side">
        <div class="form-container">
            ...
            <h2 style="letter-spacing: 2px;font-size: 24px;padding-top: 20px;">当前机器人已占用</h2>
...
<script>
    ...
    function step_name() {
        ...
        function pollBackend() {
            ...
            const stepName = 'step_search_owner'; // 这里的 step_name 可以动态设置
            ...
            fetch(`../api/turn_next_page?step_name=${encodeURIComponent(stepName)}`) // 假设后台接口是 '/check_condition'
                ...
                .then(data => {
                    if (data.redirectUrl) {
                        ...
                        window.location.href = '../page/step_search_car';
                    } else {
                        // 如果没有返回跳转地址，设置下次请求
