...
<script>
    // 创建音频对象
    var audio = new Audio('../static/audio/notice_message_show.mp3'); // 替换为实际的 MP3 文件 URL
...
<script>
    ...
    window.onload = function () {
        ...
        setTimeout(function () {
            ...
            const stepName = 'step_message_show'; // 这里的 step_name 可以动态设置
    ...
    <div class="right-side">
        <div class="form-container">
            <div style='align-items: center;justify-content: center;display: flex;'>
                <img src="../static/images/info.png" style="width: 72px;height: 72px;border-radius: 2px;">
            </div>
            <h2 style="letter-spacing: 2px;font-size: 24px;">提示</h2>
