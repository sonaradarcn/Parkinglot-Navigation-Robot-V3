...
<body>
    ...
    <div class="right-side">
        <div class="form-container">
			...
			<img src="data:image/png;base64,{{qr_code}}" style="width: 256px;height: 256px;box-shadow: 0px 0px 5px 2px rgba(0,0,0,0.1);">
			</div>
            <h2 style="letter-spacing: 2px;font-size: 24px;">扫描二维码<br/>使用机器人进行寻车</h2>
        </div>
    </div>
...
function step_name() {
    ...
    function pollBackend() {
        ...
        const stepName = 'step_qrscan'; // 这里的 step_name 可以动态设置
