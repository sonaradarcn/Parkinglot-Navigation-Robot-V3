...
<body>
    <div class="container mt-5" style="align-items: center; justify-content: center; display: flex;">
        <form action="../api/point_edit" method="get" style="width: 700px; margin-top: 20px; margin-bottom: 20px;" class="fadeIn animated">
            <h2 class="text-center mb-4">修改点</h2>
...
<div class="form-group">
    ...
    <input type="text" name="x" id="x" class="form-control" value="{{data.x}}" placeholder="请输入坐标或使用坐标自动回传功能" required>
</div>
<div class="form-group">
    <label for="y">坐标 Y</label>
    <input type="text" name="y" id="y" class="form-control" value="{{data.y}}" placeholder="请输入坐标或使用坐标自动回传功能" required>
</div>
            <div class="form-group">
                <label for="description">描述</label>
                <textarea name="description" id="description" class="form-control" rows="3" placeholder="请输入描述" >{{data.description}}</textarea>
            </div>
