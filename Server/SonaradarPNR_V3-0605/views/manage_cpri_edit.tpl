...
<body>
    <div class="container mt-5" style="align-items: center; justify-content: center; display: flex;">
        <form action="../api/cpri_edit" method="get" style="width: 700px; margin-top: 20px; margin-bottom: 20px;" class="fadeIn animated">
            <h2 class="text-center mb-4">修改CPR信息</h2>
            ...
            <div class="form-group">
                <label>区域名称</label>
                <input type="text" name="name" class="form-control" value="{{data.name}}" placeholder="请输入区域名称" required>
            </div>

            <div class="form-group">
                <label>描述</label>
                <input type="text" name="description" class="form-control" value="{{data.description}}" placeholder="请输入描述" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="cprd_id" id="cprd_id" onchange="loadImage()">
                    ...
                    <option value="{{availableCPRDevice.id}}" {% if availableCPRDevice.id == data.cprd_id %}selected{% endif %}>
                        {{availableCPRDevice.name}}(MID:{{availableCPRDevice.machine_id}})
                    </option>
                    % end
                </select>
            </div>
            ...
            <div class="form-group">
                <label>X1</label>
                <input type="number" name="x1" id="x1" class="form-control" value="{{data.x1}}" placeholder="请输入X1坐标" required readonly>
            </div>

            <div class="form-group">
                <label>Y1</label>
                <input type="number" name="y1" id="y1" class="form-control" value="{{data.y1}}" placeholder="请输入Y1坐标" required readonly>
            </div>

            <div class="form-group">
                <label>X2</label>
                <input type="number" name="x2" id="x2" class="form-control" value="{{data.x2}}" placeholder="请输入X2坐标" required readonly>
            </div>

            <div class="form-group">
                <label>Y2</label>
                <input type="number" name="y2" id="y2" class="form-control" value="{{data.y2}}" placeholder="请输入Y2坐标" required readonly>
            </div>
